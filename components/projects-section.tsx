  ...
  const projects = [
    {
      ...
      technologies: ["React", "TypeScript", "Tailwind CSS","REST API", "Firebase", "Zustand", "ShadcnUI"],
    ...
    },
    {
      ...
      description: "An interactive task management app with drag-and-drop boards, progress tracking, and analytics. Users can manage tasks by category, view deadlines, and track progress with charts and a calendar view.",
      image: "/TaskFlowImage.png",
      technologies: ["React", "Typescript", "Tailwind CSS", "Zustand", "Recharts", "React Big Calendar"],
    ...
    },
    {
      ...
      technologies: ["Vue.js", "Express.js", "PostgreSQL", "Chart.js", "Vuetify"],
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A showcase of my recent work and personal projects that demonstrate my skills and passion for frontend
            development.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {otherProjects.map((project, index) => (
              <Card key={index} className="hover:shadow-lg transition-shadow duration-300 group">
                ...
                <CardContent>
                  <p className="text-muted-foreground text-sm mb-4 line-clamp-5">{project.description}</p>
